        ...
        try {
            $response = $this->openAIClient->chat()->create([
                ...
                'messages' => [
                    ...
                    ['role' => 'system', 'content' => "If the current time is close to the end of the day, move tasks with start_time near midnight to the next day. However, ensure that the new start_time does not exceed the deadline and avoid scheduling tasks between 1 AM and 6 AM."],
                    // ['role' => 'system', 'content' => "If the current time is close to the end of the day, move tasks with start_time near midnight to the next day. However, ensure that the new start_time does not exceed the deadline."],
                    ['role' => 'system', 'content' => "**Ensure that start_time is never changed to a value earlier than its original. It can only remain the same or be updated to a later time.**"],
