    ...
    public function rearrangeByAI(array $params)
    {
        ...
        try {
            $response = $this->openAIClient->chat()->create([
                ...
                'messages' => [
                    ['role' => 'system', 'content' => 'You are an AI scheduling assistant that creates an optimized or recreate the schedules, conflict-free, and well-balanced schedule for the user. Your goal is to avoid task overload, prevent overlapping, and ensure a smooth workflow.'],
